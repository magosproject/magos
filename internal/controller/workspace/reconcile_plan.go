...
//   - planSucceeded == false: return result to the caller (job is running,
//     failed, or was just created). The caller must not proceed to apply.
//   - planSucceeded == true: the plan finished successfully, the caller may
//     proceed to Step 7.
func (r *WorkspaceReconciler) reconcilePlanJob(
	ctx context.Context,
	workspace *v1alpha1.Workspace,
	planJobName, planFile, pvcName string,
	planJobGetErr error,
	planJob *batchv1.Job,
	...
	if planJobGetErr != nil {
		...
		return ctrl.Result{}, false, planJobGetErr
	}
