...
type ProjectLister interface {
	...
	List(selector labels.Selector) (ret []*magosprojectv1alpha1.Project, err error)
...
type projectLister struct {
	listers.ResourceIndexer[*magosprojectv1alpha1.Project]
}

// NewProjectLister returns a new ProjectLister.
func NewProjectLister(indexer cache.Indexer) ProjectLister {
	return &projectLister{listers.New[*magosprojectv1alpha1.Project](indexer, magosprojectv1alpha1.Resource("project"))}
}

// Projects returns an object that can list and get Projects.
func (s *projectLister) Projects(namespace string) ProjectNamespaceLister {
	return projectNamespaceLister{listers.NewNamespaced[*magosprojectv1alpha1.Project](s.ResourceIndexer, namespace)}
}
...
type ProjectNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*magosprojectv1alpha1.Project, error)
