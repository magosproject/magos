...
func (c *ApiV1alpha1Client) Projects(namespace string) ProjectInterface {
	return newProjects(c, namespace)
}

func (c *ApiV1alpha1Client) Rollouts(namespace string) RolloutInterface {
	return newRollouts(c, namespace)
}

func (c *ApiV1alpha1Client) VariableSets(namespace string) VariableSetInterface {
