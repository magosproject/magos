...
type VariableSetInformer interface {
	...
	Lister() magosprojectv1alpha1.VariableSetLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MagosprojectV1alpha1().VariableSets(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().VariableSets(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().VariableSets(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().VariableSets(namespace).Watch(ctx, options)
			},
		}, client),
		&typesmagosprojectv1alpha1.VariableSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *variableSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&typesmagosprojectv1alpha1.VariableSet{}, f.defaultInformer)
}

func (f *variableSetInformer) Lister() magosprojectv1alpha1.VariableSetLister {
	return magosprojectv1alpha1.NewVariableSetLister(f.Informer().GetIndexer())
}
