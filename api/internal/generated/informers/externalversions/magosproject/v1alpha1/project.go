...
type ProjectInformer interface {
	...
	Lister() magosprojectv1alpha1.ProjectLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MagosprojectV1alpha1().Projects(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().Projects(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().Projects(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MagosprojectV1alpha1().Projects(namespace).Watch(ctx, options)
			},
		}, client),
		&typesmagosprojectv1alpha1.Project{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *projectInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&typesmagosprojectv1alpha1.Project{}, f.defaultInformer)
}

func (f *projectInformer) Lister() magosprojectv1alpha1.ProjectLister {
	return magosprojectv1alpha1.NewProjectLister(f.Informer().GetIndexer())
}
