...
type VariableSetInformer interface {
	...
	Lister() apiv1alpha1.VariableSetLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().VariableSets(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().VariableSets(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().VariableSets(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().VariableSets(namespace).Watch(ctx, options)
			},
		}, client),
		&magosapiv1alpha1.VariableSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *variableSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&magosapiv1alpha1.VariableSet{}, f.defaultInformer)
}

func (f *variableSetInformer) Lister() apiv1alpha1.VariableSetLister {
	return apiv1alpha1.NewVariableSetLister(f.Informer().GetIndexer())
}
