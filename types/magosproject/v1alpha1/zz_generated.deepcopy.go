...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunLogSummary) DeepCopyInto(out *RunLogSummary) {
	*out = *in
	if in.StartedAt != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunLogSummary.
func (in *RunLogSummary) DeepCopy() *RunLogSummary {
	if in == nil {
		return nil
	}
	out := new(RunLogSummary)
	in.DeepCopyInto(out)
	return out
}
