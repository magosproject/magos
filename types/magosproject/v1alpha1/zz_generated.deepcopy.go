...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconcileRun) DeepCopyInto(out *ReconcileRun) {
	*out = *in
	if in.Plan != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconcileRun.
func (in *ReconcileRun) DeepCopy() *ReconcileRun {
	if in == nil {
		return nil
	}
	out := new(ReconcileRun)
	in.DeepCopyInto(out)
	return out
}
